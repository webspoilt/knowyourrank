                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full h-10 px-3 border border-gray-300 rounded-md text-sm text-gray-900 bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                      >
